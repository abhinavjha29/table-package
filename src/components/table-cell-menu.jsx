...
const DefaultTableCellMenuButton = ({ setPopupOpen }) => (
  <button
    onClick={() => {
      setPopupOpen(true);
    }}
    onMouseDown={(event) => {
      // Stop the parent component from listening to the onMouseDown event
...
const DefaultTableCellMenuItem = (props) => (
  <button
    disabled={props.disabled}
    onClick={props.onClick}
    className={ComponentsTheme.MENU_ITEM}
  >
    {props.label}
  </button>
);

const DefaultTableCellMenuPopup = ({ setPopupOpen, popupOpen }) => {
  ...
  // because we want users to quickly try multiple colors.
...
const DefaultTableCellMenuComponent = (props) => (
  <>
...
const TableCellMenu = ({ Component = DefaultTableCellMenuComponent }) => {
